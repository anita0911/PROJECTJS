...
const Banksubmit=require('./routes/Banksubmit');
const authentication=require('./routes/authentication');
const Banklogout=require('./routes/Banklogout');
const Bankemail =require('./routes/Bankemail');
...
app.get('/logout',Banklogout);
app.post('/checkmail',Bankemail);
app.post('/authe',authen);
